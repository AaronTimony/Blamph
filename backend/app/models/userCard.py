...
CREATE TABLE user_cards_p5 PARTITION OF user_cards FOR VALUES WITH (MODULUS 8, REMAINDER 4);
CREATE TABLE user_cards_p6 PARTITION OF user_cards FOR VALUES WITH (MODULUS 8, REMAINDER 5);
CREATE TABLE user_cards_p7 PARTITION OF user_cards FOR VALUES WITH (MODULUS 8, REMAINDER 6);
CREATE TABLE user_cards_p8 PARTITION OF user_cards FOR VALUES WITH (MODULUS 8, REMAINDER 7);"""
